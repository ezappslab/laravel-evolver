...
test('action command normalizes direct class name input and uses the package stub', function () {
...
test('action command refuses silent overwrite', function () {
...
test('action command rejects a name that cannot form a class', function () {
